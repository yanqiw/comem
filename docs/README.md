...
- [Quickstart](quickstart.md) — install, run the server, wire up a client, set
  up your agent, open the dashboard.
- [Concepts & governance model](concepts.md) — roles, the accepted-truth rule,
